...
if (isset($_POST['one'])) {
 ...
 CREATE TABLE ".DB_PREFIX."keywords (
  ...
  `key_date` date NOT NULL default '1000-01-01',
  PRIMARY KEY  (`key_id`),
  KEY `kid` (`key_sur_id`),
  KEY `kqid` (`key_que_id`)
 ) ENGINE=MyISAM DEFAULT CHARSET=utf8
 ...
 CREATE TABLE ".DB_PREFIX."surveys (
  ...
  `sur_date_expire` date NOT NULL default '1000-01-01',
  ...
  `sur_dare_created` datetime NOT NULL default '1000-01-01 00:00:01',
 ...
 CREATE TABLE ".DB_PREFIX."users (
  ...
  `usr_date` date NOT NULL default '1000-01-01',
