...
?>		
      ...
      <?php
      $q_surveys = mysqli_query($connect,"SELECT * FROM ".DB_PREFIX."surveys
      ...
      while ($SURVEYS = mysqli_fetch_object($q_surveys)) {
      ?>
